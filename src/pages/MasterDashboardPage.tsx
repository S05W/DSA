...
export default function MasterDashboardPage() {
  ...
  return <div className="app-shell"><Sidebar /><main className="app-main master-dashboard"><Header eyebrow="Spielleitung" title="Meisterübersicht" subtitle="Alle Helden, die ihre Teilnahme an der aktuellen Sitzung aktiviert haben." />
    ...
    <section className="dsa-panel map-roadmap"><div><span>Kartenansicht</span><small>Nächste Ausbaustufe</small></div><p>Hier kommt später die Meisterkarte mit verschiebbarer Ansicht, Nebelmaske und einer getrennten Fernseher-Ausgabe hinzu.</p></section>
  </main></div>;
}
