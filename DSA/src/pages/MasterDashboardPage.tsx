...
export default function MasterDashboardPage() {
  ...
  return <div className="app-shell"><Sidebar /><main className="app-main master-dashboard"><Header eyebrow="Spielleitung" title="Meisterübersicht" subtitle="Alle Helden, die ihre Teilnahme an der aktuellen Sitzung aktiviert haben." />
    ...
    <section className="master-tool-grid">
      ...
      <Link to="/meister/handouts" className="dsa-panel map-roadmap"><div><span>Handouts</span><small>Briefe, Hinweise, Porträts und Illustrationen</small></div><p>Bereite Bildmaterial vor und enthülle es für alle oder nur für einen bestimmten Spieler.</p><b>Handouts verwalten →</b></Link>
    </section>
  </main></div>;
}
